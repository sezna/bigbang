...
# Getting started With Gravitational Simulation
...
If you have no custom fields to keep track of on your struct and just want to simulate raw particles, you can use `grav_tree::entity::Entity` directly, as is done in `examples/sample_simulation.rs`. 
...
```rust
let mut my_fun_vec = vec![entity1, entity2, entity3];
