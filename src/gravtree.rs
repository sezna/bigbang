...
impl GravTree {
    ...
    pub fn as_vec(&self) -> Vec<Entity> {
        ...
        match node.left {
            Some(ref node) => {
                println!("appended an entity left");
        ...
        match node.right {
            Some(ref node) => {
                println!("appended a entityi right");
                to_return.append(&mut node.traverse_tree_helper());
            }
            None => {
                to_return.append(
    ...
    pub fn time_step(&self) -> GravTree {
        ...
        return GravTree::new(&mut post_gravity_entity_vec);
    }
